                    ...
                    <div class="col-lg-4 col-sm-6 portfolio-item">
                        <div class="card h-100">
                            ...
                            <div class="card-block">
                                ...
                                <input type="text" value="0" name="jumlah[]" class="jumlah text-center" id="jumlah1" style="width: 120px; height:35px" disabled>
                    ...
                    <div class="col-lg-4 col-sm-6 portfolio-item">
                        <div class="card h-100">
                            ...
                            <div class="card-block">
                                ...
                                <input type="text" value="0" class="jumlah text-center" id="jumlah2" style="width: 120px; height:35px" disabled>
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <div class="card-block">
                        ...
                        <input type="text" value="0" class="jumlah text-center" id="jumlah4" style="width: 120px; height:35px"  disabled>
            ...
            <div class="col-lg-4 col-sm-6 portfolio-item">
                <div class="card h-100">
                    ...
                    <div class="card-block">
                        ...
                        <input type="text" value="0" class="jumlah text-center" id="jumlah5" style="width: 120px; height:35px"  disabled>
